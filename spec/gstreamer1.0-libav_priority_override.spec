...
Patch0: gst_libav_priority_override.diff
...
%configure \
  --with-package-name='GStreamer libav Plug-ins' \
  --disable-static \
  --enable-shared \
  --disable-gtk-doc \
...
#  --with-libav-extra-configure="--disable-encoders --disable-muxers --disable-demuxers --disable-decoders --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=h264 --enable-encoder=h264 --disable-yasm"
#  --enable-lgpl \
...
%install
%make_install
rm -rf ${RPM_BUILD_ROOT}/usr/share/gtk-doc/html/gst-libav-plugins-1.0
